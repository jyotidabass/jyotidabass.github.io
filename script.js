...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.timeline-item, .research-card, .skill-category, .achievement-card, .contact-item');
...
// Enhanced skill items hover effect with 3D transform
document.querySelectorAll('.skill-item').forEach(item => {
    item.addEventListener('mouseenter', () => {
        item.style.transform = 'scale(1.1) rotateY(10deg)';
        item.style.boxShadow = '0 8px 25px rgba(102, 126, 234, 0.4)';
        item.style.zIndex = '10';
    });
    
    item.addEventListener('mouseleave', () => {
        item.style.transform = 'scale(1) rotateY(0deg)';
        item.style.boxShadow = '0 4px 15px rgba(102, 126, 234, 0.3)';
        item.style.zIndex = '1';
    });
});
...
function createCustomCursor() {
    ...
    const interactiveElements = document.querySelectorAll('a, button, .btn, .skill-item, .achievement-card');
